...
import {MIME_TYPE, RoleIds} from '@enums';
import {list} from '@utils/enum.util';
import {getMedia, insertMedia, listMedias, removeMedia, replaceMedia, updateMedia} from '@validations/media.validation';
...
export class MediaRouter extends Router {
    ...
    define(): void {
        ...
        this.router.route('/')
             ...
             */
            .get(Guard.authorize([RoleIds.admin, ROLE.user]), Validator.check(listMedias), MediaController.list)
             ...
             * @apiUse NotAcceptable
             */
            .post(Guard.authorize([RoleIds.admin, ROLE.user]), Uploader.upload({wildcards: list(MIME_TYPE)}), Validator.check(insertMedia), MediaController.create);
        ...
        this.router.route('/:mediaId')
             ...
             */
            .get(Guard.authorize([RoleIds.admin, ROLE.user]), Validator.check(getMedia), MediaController.get)
             ...
             * @apiUse ExpectationFailed
             */
            .put(Guard.authorize([RoleIds.admin, ROLE.user]), Validator.check(replaceMedia), MediaController.get, Uploader.upload({wildcards: list(MIME_TYPE)}), Validator.check(insertMedia), MediaController.update)
             ...
             * @apiUse ExpectationFailed
             */
            .patch(Guard.authorize([RoleIds.admin, ROLE.user]), Validator.check(updateMedia), MediaController.get, Uploader.upload({wildcards: list(MIME_TYPE)}), MediaController.update)
             ...
             * @apiUse ExpectationFailed
             */
            .delete(Guard.authorize([RoleIds.admin, ROLE.user]), Validator.check(removeMedia), MediaController.get, MediaController.remove);
